...
const StreamlineBox = class {
    ...
    render() {
        return (h(Host, null, h("div", { class: "inner w-full h-full absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[900px] max-h-[700px] bg-white overflow-hidden grid" }, h("streamline-sidebar", null), h("div", { class: "wrap h-full absolute left-[var(--sl-side-w)] w-[calc(100%-var(--sl-side-w))]" }, h("div", { class: "focus" }, h("input", { part: "search", class: "px-4 sm:px-6 search h-[var(--sl-side-w)] text-[1.15rem] w-full h-full m-0 p-0 border-b border-gray-300", type: "text", placeholder: "Search for anything", onInput: (event) => StreamlineBox.handleChange(event) })), h("streamline-entries", null)))));
    }
