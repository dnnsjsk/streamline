...
const StreamlineButton = class {
    ...
    render() {
        ...
        const className = `inner w-[max-content] underline-none cursor-pointer text-center whitespace-no-wrap rounded-lg transition ease-in duration-100 ${this.type === "main"
