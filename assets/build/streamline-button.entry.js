...
const StreamlineButton = class {
  ...
  render() {
    ...
    return (h("div", { class: 'focus' + (this.type ? ` ${this.type}` : '') }, h("button", { onClick: () => this.handleClick(), class: 'container' + (this.type ? ` ${this.type}` : '') }, this.icon === 'wordpress'
      ? iconWordpress
      : this.icon === 'menu'
        ? iconMenu
