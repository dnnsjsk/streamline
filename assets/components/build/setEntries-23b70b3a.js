...
import { s as sort } from './sort-8306feea.js';
...
const getEntriesSliced = (item) => {
  const min = (state.entriesPostCurrentPage - 1) * state.entriesSettingsLoad.query.amount;
  const max = state.entriesPostCurrentPage * state.entriesSettingsLoad.query.amount;
  return isArray(item)
    ? item.slice(min, max)
    : isObject$1
...
const sortEntries = () => {
  var _a, _b;
  if (((_a = state === null || state === void 0 ? void 0 : state.sort) === null || _a === void 0 ? void 0 : _a.post) || ((_b = state === null || state === void 0 ? void 0 : state.sort) === null || _b === void 0 ? void 0 : _b.site)) {
    Object.entries(state === null || state === void 0 ? void 0 : state.sort).forEach(([key, value]) => {
      sort({
        id: value.id,
        type: key,
...
const setEntries = (removeSort = '') => {
  ...
  0 !== 0 && state.active === 'post'
    ...
    : state[`entries${capitalizeFirstLetter(state.active)}`], (o) => {
    return ((o.name &&
      ...
      : [
        {
          ...
          children: [],
          isMultisite: (_c = state === null || state === void 0 ? void 0 : state.data) === null || _c === void 0 ? void 0 : _c.network,
  ...
  if (removeSort === '') {
    ...
    state.sort = Object.assign(Object.assign({}, state.sort), { [removeSort]: false });
  }
  // console.log(state[`entries${capitalizeFirstLetter(state.active)}Active`]);
};

export { findDeep as a, set as b, compact as c, someDeep as d, filterDeep as f, get as g, merge as m, setEntries as s, unset as u };
