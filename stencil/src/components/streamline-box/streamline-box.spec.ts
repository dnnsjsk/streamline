...
<streamline-box>
      <mock:shadow-root>
        <div class="-translate-x-1/2 -translate-y-1/2 absolute bg-white grid h-full inner left-1/2 max-h-[700px] max-w-[1000px] overflow-hidden top-1/2 w-full">
          ...
          <div class="absolute h-full left-[var(--sl-side-w)] w-[calc(100%-var(--sl-side-w))] wrap">
            ...
            <streamline-entries>
              <mock:shadow-root>
                <div class="h-full lg:h-[calc(100%+64px)] relative">
                  <div class="bg-white focus-none h-[calc(100%-var(--sl-side-w))] inner lg:pb-10 lg:px-8 overflow-x-hidden overflow-y-scroll pb-6 px-3 relative sm:px-6 w-full" tabindex="-1">
                    <div>
