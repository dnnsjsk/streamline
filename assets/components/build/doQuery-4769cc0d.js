...
function doQuery(obj) {
  ...
  `${streamline.rest}streamline/v1/${obj.callback}?siteId=${state.currentSite.id}&userId=${state.data.userId}&value=${obj.search}&amount=${state.entriesSettingsLoad.queryAmount}`, {
    method: 'GET',
