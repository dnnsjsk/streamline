...
let StreamlineUiDrawer = class {
  ...
  render() {
    return (h(Host, { class: {
      ...
      } }, state.drawer.title && (h("h1", { class: "px-4 py-8 text-center text-lg text-gray-900 font-medium" }, state.drawer.title)), h("div", { class: "p-4 pt-0 overflow-y-auto space-y-8" }, state.drawer.items.map((item) => {
      ...
      } }, h(Button, { onClick: this.save, type: "primary", text: "Save", class: "w-full !py-4 !text-base", invalid: !this.canSave }))), h("div", null)));
  }
