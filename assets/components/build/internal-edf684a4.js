import { f as getRenderingRef, i as forceUpdate } from './index-e8dc94cb.js';
...
function blurSearch() {
  var _a, _b, _c, _d, _e;
  (_e = (_d = (_c = (_b = (_a = document === null || document === void 0 ? void 0 : document.querySelector('streamline-container')) === null || _a === void 0 ? void 0 : _a.shadowRoot) === null || _b === void 0 ? void 0 : _b.querySelector('streamline-search')) === null || _c === void 0 ? void 0 : _c.shadowRoot) === null || _d === void 0 ? void 0 : _d.querySelector('input')) === null || _e === void 0 ? void 0 : _e.blur();
}
...
function setSearchPlaceholder() {
  ...
  state.searchPlaceholder =
    state$1.active === 'post' || state$1.active === 'site'
      ? `${state.test
        ? 'Filter entries'
        : Object.values(state[`entries${capitalizeFirstLetter(state$1.active)}`]).length >= 1
          ? `Search for a ${state$1.active} or filter entries`
          : `Search for a ${state$1.active}`}${commands}`
...
function setEntries() {
  const result = filterDeep(state[`entries${capitalizeFirstLetter(state$1.active)}`], (o) => {
    return ((o.name &&
...
function resetView() {
  ...
  if (state$1.active === 'site' || state$1.active === 'post') {
...
const { state: state$1, dispose: dispose$1, onChange: onChange$1 } = s('streamline', {
  active: 'menu',
});
onChange$1('active', () => {
  resetView();
          ...
          children: [
            {
              ...
              name: 'Post amount',
              nameParent: 'Queries',
              label: `Maximum amount of displayed posts${
              // @ts-ignore
              window.streamlineData.network ? '/sites' : ''} per page`,
            },
          ],
          name: 'Queries',
        },
...
onChange('visible', (value) => {
  var _a, _b, _c, _d;
  if (!state.menus.includes(state$1.active)) {
    state$1.active = 'menu';
  }
  else if (state.entriesSettingsLoad.behaviourDefaultTab.default !== 'last') {
    state$1.active = state.entriesSettingsLoad.behaviourDefaultTab.default;
  }
  ...
  if (el) {
    ...
    if (value === true) {
      values.forEach((item) => {
        ...
        if (style) {
          state.bodyStyle = Object.assign(Object.assign({}, state.bodyStyle), { [item]: style });
        }
      });
...
export { SetCache as $, assignValue as A, keysIn as B, get as C, isArguments as D, arrayPush as E, overRest as F, baseGetTag as G, isPlainObject as H, baseRest as I, toKey as J, baseAssignValue as K, baseSlice as L, toString as M, arrayReduce as N, toNumber as O, isIterateeCall as P, baseClone as Q, baseIteratee as R, Symbol as S, arrayMap as T, baseEach as U, baseAssign as V, WeakMap as W, eq as X, baseMerge as Y, baseUnary as Z, cacheHas as _, state$1 as a, toPath as a$, isArrayLikeObject as a0, last as a1, getTag$1 as a2, mapToArray as a3, arrayFilter as a4, baseForOwn as a5, baseForOwnRight as a6, baseFor as a7, castFunction as a8, baseForRight as a9, baseTimes as aA, isBuffer as aB, isTypedArray as aC, getPrototype as aD, baseTrim as aE, trimmedEndIndex as aF, Set$1 as aG, takeRight as aH, forEach as aI, forEachRight as aJ, reduce as aK, memoize as aL, clone as aM, cloneDeep as aN, isEmpty as aO, isEqual as aP, isLength as aQ, isMap as aR, isSet as aS, toPlainObject as aT, has as aU, merge as aV, set as aW, unset as aX, iteratee as aY, property as aZ, stubArray as a_, isFunction as aa, toFinite as ab, isString as ac, constant as ad, castPath as ae, parent as af, nodeUtil as ag, baseIsEqual as ah, baseIsMatch as ai, getMatchData as aj, coreJsData as ak, stubFalse as al, baseIsNative as am, baseMatches as an, baseMatchesProperty as ao, setToArray as ap, getAllKeysIn as aq, baseUnset as ar, baseGet as as, baseSet as at, arraySome as au, baseProperty as av, hasIn as aw, baseReduce as ax, baseEachRight as ay, baseKeys as az, setEntries as b, filterDeep as b0, capitalizeFirstLetter as b1, findDeep as b2, someDeep as b3, onChange$1 as b4, onChange as b5, setSearchPlaceholder as c, baseToString as d, identity as e, focusSearch as f, baseCreate as g, isObject$1 as h, isSymbol as i, root as j, copyArray as k, isObjectLike as l, isArray as m, shortOut as n, arrayEach as o, setToString as p, isIndex as q, resetView as r, state as s, toInteger as t, apply as u, createAssigner as v, isPrototype as w, isArrayLike as x, copyObject as y, keys as z };
