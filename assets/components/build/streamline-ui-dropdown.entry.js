...
import { l as IconDots, m as IconLink } from './index-7b69af99.js';
...
let StreamlineUiDropdown = class {
  ...
  render() {
    return (h("div", { role: "button", ref: (el) => (this.button = el), onFocus: this.setPosition, onMouseEnter: this.setPosition, onMouseDown: (e) => e.preventDefault(), class: {
        'focus-white flex w-full h-full items-center justify-center group hover:opacity-100 focus:opacity-100 focus-within:opacity-100 hover:text-blue-600 focus:text-blue-600 focus-within:text-blue-600 hover:z-50': true,
        'opacity-0 relative !opacity-100 !pointer-events-auto': this.type === 'main',
        'opacity-100': this.type === 'entry',
      } }, h(IconDots, null), h("div", { ref: (el) => (this.dropdown = el), class: {
        'flex flex-col border border-slate-400 shadow-md fixed transform opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto group-focus:opacity-100 group-focus:pointer-events-auto focus-within:opacity-100 focus-within:pointer-events-auto': true,
        'z-50': this.type === 'main',
        'z-30': this.type !== 'main',
      ...
      return ((item === null || item === void 0 ? void 0 : item.text) && (h("a", { onFocus: this.setPosition, tabindex: 0, href: item.href && item.href, onMouseDown: (e) => e.preventDefault(), class: {
          'text-left inline-flex items-center w-full bg-white focus-white px-3 py-2 whitespace-nowrap text-sm font-medium text-slate-900 hover:text-blue-600': true,
          'border-t border-slate-100': item.border,
        }, onClick: () => {
          item.onClick && item.onClick();
        } }, item.text, item.href && (h("span", { class: "pl-3 ml-auto text-slate-400" }, h(IconLink, null))))));
    }))));
  }
  get el() { return getElement(this); }
};
StreamlineUiDropdown.style = streamlineUiDropdownCss;

export { StreamlineUiDropdown as streamline_ui_dropdown };
