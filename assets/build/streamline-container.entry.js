import { r as registerInstance, h, e as Host } from './index-62dd23ad.js';
import { s as state } from './internal-0465a79e.js';
import { s as state$1, a as setActiveEntries } from './setActiveEntries-bed90b38.js';
...
const StreamlineContainer = class {
                ...
                subSubMenu.forEach((itemSub, indexSub) => {
                    if ((indexSub !== 0 && subSubMenu.length >= 2) ||
                        ...
                        subArr.push({
                            ...
                            nameParent: name,
                            href: hrefSub,
                            favourite: !!state$1.menuFavourites.includes(hrefSub),
                        });
                    }
                });
            }
    ...
    render() {
        return (h(Host, null, state.visible && (h("div", { class: "fixed top-0 left-0 w-full h-full z-[9999999999999999]" }, h("div", { tabIndex: -1, class: "fixed top-0 left-0 w-full h-full bg-black/90", onClick: () => (state.visible = false) }), h("streamline-box", null)))));
    }
};
StreamlineContainer.style = streamlineContainerCss + '/*! tailwindcss v2.2.16 | MIT License | https://tailwindcss.com*//*! modern-normalize v1.1.0 | MIT License | https://github.com/sindresorhus/modern-normalize */*,:after,:before{--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;border:0 solid;box-sizing:border-box}a{color:inherit;text-decoration:inherit}.visible{visibility:visible}.fixed{position:fixed}.top-0{top:0}.left-0{left:0}.z-\\[9999999999999999\\]{z-index:10000000000000000}.h-full{height:100%}.w-full{width:100%}.bg-black\\/90{background-color:rgba(0,0,0,.9)}.shadow{--tw-shadow:0 1px 3px 0 rgba(0,0,0,0.1),0 1px 2px 0 rgba(0,0,0,0.06);box-shadow:var(--tw-ring-offset-shadow,0 0 #0000),var(--tw-ring-shadow,0 0 #0000),var(--tw-shadow)}';
