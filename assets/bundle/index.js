...
const streamlineButtonCss = ".tippy-box[data-animation=fade][data-state=hidden]{opacity:0}[data-tippy-root]{max-width:calc(100vw - 10px)}.tippy-box{background-color:#333;border-radius:4px;color:#fff;font-size:14px;line-height:1.4;outline:0;position:relative;transition-property:transform,visibility,opacity;white-space:normal}.tippy-box[data-placement^=top]>.tippy-arrow{bottom:0}.tippy-box[data-placement^=top]>.tippy-arrow:before{border-top-color:initial;border-width:8px 8px 0;bottom:-7px;left:0;transform-origin:center top}.tippy-box[data-placement^=bottom]>.tippy-arrow{top:0}.tippy-box[data-placement^=bottom]>.tippy-arrow:before{border-bottom-color:initial;border-width:0 8px 8px;left:0;top:-7px;transform-origin:center bottom}.tippy-box[data-placement^=left]>.tippy-arrow{right:0}.tippy-box[data-placement^=left]>.tippy-arrow:before{border-left-color:initial;border-width:8px 0 8px 8px;right:-7px;transform-origin:center left}.tippy-box[data-placement^=right]>.tippy-arrow{left:0}.tippy-box[data-placement^=right]>.tippy-arrow:before{border-right-color:initial;border-width:8px 8px 8px 0;left:-7px;transform-origin:center right}.tippy-box[data-inertia][data-state=visible]{transition-timing-function:cubic-bezier(.54,1.5,.38,1.11)}.tippy-arrow{color:#333;height:16px;width:16px}.tippy-arrow:before{border-color:transparent;border-style:solid;content:\"\";position:absolute}.tippy-content{padding:0;position:relative;z-index:1}:host .focus{border-radius:var(--sl-border-radius);box-sizing:border-box;display:flex;outline:none;position:relative;width:100%}:host .focus:hover+.focus .icon{opacity:1}:host .focus a:focus,:host .focus button:focus,:host .focus input:focus{outline:none}:host .focus:before{border-radius:var(--sl-border-radius);box-sizing:border-box;content:\"\";height:calc(100% - 8px);left:4px;pointer-events:none;position:absolute;top:4px;transition:box-shadow var(--sl-transition-fast);width:calc(100% - 8px)}:host .focus:focus-within:before{box-shadow:inset 0 0 0 2px var(--sl-focus-color)}:host .focus.is-header:before,:host .focus.is-icon:before,:host .focus.is-main:before{height:100%;left:0;top:0;width:100%}:host .focus.is-icon{width:auto}/*! tailwindcss v2.2.16 | MIT License | https://tailwindcss.com*//*! modern-normalize v1.1.0 | MIT License | https://github.com/sindresorhus/modern-normalize */*,:after,:before{border:0 solid;box-sizing:border-box}.visible{visibility:visible}/*! tailwindcss v2.2.16 | MIT License | https://tailwindcss.com*//*! modern-normalize v1.1.0 | MIT License | https://github.com/sindresorhus/modern-normalize *//*! tailwindcss v2.2.16 | MIT License | https://tailwindcss.com*//*! modern-normalize v1.1.0 | MIT License | https://github.com/sindresorhus/modern-normalize *//*! tailwindcss v2.2.16 | MIT License | https://tailwindcss.com*//*! modern-normalize v1.1.0 | MIT License | https://github.com/sindresorhus/modern-normalize */";
...
const StreamlineButton$1 = class extends HTMLElement {
    constructor() {
        ...
        this.handleFavClick = () => {
            ...
            if ((this.typeSub === "menu" &&
                ...
                (this.typeSub === "flow" &&
                    getFavourites(state$1.entries, "flow") === null)) {
    ...
    render() {
        ...
        const className = `break-words w-[max-content] underline-none cursor-pointer text-center whitespace-no-wrap rounded-lg transition ease-in duration-100 ${this.type === "main"
            ...
            : this.type === "sidebar" || this.type === "primary"
                ? `h-[calc(var(--sl-side-w)+8px)] w-[calc(var(--sl-side-w)-1px)] flex flex-col items-center justify-center p-0 rounded-none text-gray-900 bg-transparent border-b border-gray-300 ${this.type === "primary"
...
const StreamlineContainer$1 = class extends HTMLElement {
    ...
    componentDidLoad() {
        ...
        /** Get menu. */
        const mainMenu = state$1.data.menu.top;
        const subMenu = state$1.data.menu.sub;
        let data = [];
        const menu = [];
            ...
            if (subMenu[item[2]]) {
                Object.values(subMenu[item[2]]).forEach((itemSub, indexSub) => {
                    ...
                    subArr.push({
                        ...
                        nameParent: name,
                        href: urlSub,
                        favourite: !!state.menuFavourites.includes(urlSub),
                    });
                });
            }
            else {
                subArr.push({
                    ...
                    nameParent: name,
                    href: url,
                    favourite: !!state.menuFavourites.includes(url),
                });
            }
            menu.push({
                index,
                ...
                subSubMenu.forEach((itemSub, indexSub) => {
                    if ((indexSub !== 0 && subSubMenu.length >= 2) ||
                        ...
                        subArr.push({
                            ...
                            nameParent: name,
                            href: hrefSub,
                            favourite: !!state.menuFavourites.includes(hrefSub),
                        });
                    }
                });
            }
...
const streamlineEntriesCss = "/*! tailwindcss v2.2.16 | MIT License | https://tailwindcss.com*//*! modern-normalize v1.1.0 | MIT License | https://github.com/sindresorhus/modern-normalize */*,:after,:before{border:0 solid;box-sizing:border-box}.visible{visibility:visible}/*! tailwindcss v2.2.16 | MIT License | https://tailwindcss.com*//*! modern-normalize v1.1.0 | MIT License | https://github.com/sindresorhus/modern-normalize */";
...
const StreamlineEntries$1 = class extends HTMLElement {
        ...
        return (state$1.entriesActive !== null &&
            Object.values(state$1.entriesActive).map((item) => {
                return (h("div", null, h("div", { class: `${item.type} mx-3 mb-4 pb-1 flex justify-between items-end sticky top-0 bg-white z-10 border-b border-dotted border-gray-900 sm:mx-6` }, h("h1", { class: `text-gray-900 font-medium text-xl mt-4 mb-2 sm:text-2xl sm:mt-5` }, item.name), h("div", { class: `mb-1.5` }, ((item.type === "menu" &&
                    getFavourites(state$1.entries, "menu")) ||
                    (item.type === "flow" &&
                        getFavourites(state$1.entries, "flow"))) && (h("streamline-button", { header: "favourite", type: "header", typeSub: item.type, icon: "heart" })))), h("ul", null, item.children.map((itemInner, indexInner) => {
    ...
    render() {
        return (h("div", { class: `h-[calc(100%-var(--sl-side-w))] overflow-auto w-full`, tabIndex: -1 }, state$1.entries && this.renderEntries()));
    }
    get el() { return this; }
...
const StreamlineSidebar$1 = class extends HTMLElement {
    ...
    render() {
        return (h("nav", { class: `bg-gray-50 h-full w-[var(--sl-side-w)] grid-flow-row grid auto-rows-max rounded-none border-r border-gray-300` }, h("streamline-button", { type: "primary", icon: "wordpress", onClick: () => (state$1.visible = false) }), h("div", { class: `grid-flow-row grid auto-rows-max` }, h("streamline-button", { type: "sidebar", text: "Menu", icon: "menu" }))));
    }
...
const StreamlineBox = /*@__PURE__*/proxyCustomElement(StreamlineBox$1, [1,"streamline-box",{"value":[32]}]);
...
export { StreamlineBox, StreamlineButton, StreamlineContainer, StreamlineEntries, StreamlineSidebar, defineCustomElements };
