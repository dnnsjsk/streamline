...
function assignValue(object, key, value) {
  ...
  if (!(hasOwnProperty$i.call(object, key) && eq(objValue, value)) ||
      (value === undefined && !(key in object))) {
    baseAssignValue(object, key, value);
  }
}
...
/** Built-in value references. */
var propertyIsEnumerable = objectProto$f.propertyIsEnumerable;
...
cloneableTags[arrayBufferTag$1] = cloneableTags[dataViewTag] =
...
function iteratee(func) {
  return baseIteratee(typeof func == 'function' ? func : baseClone(func, CLONE_DEEP_FLAG$5));
}
...
function toNumber(value) {
  ...
  return (isBinary || reIsOctal.test(value))
    ...
    : (reIsBadHex.test(value) ? NAN$2 : +value);
}
...
function getEntriesSliced(item) {
  const min = (state.entriesPostCurrentPage - 1) *
    state.entriesSettingsLoad.queryAmount.default;
  const max = state.entriesPostCurrentPage *
    state.entriesSettingsLoad.queryAmount.default;
  return isArray(item)
    ? item.slice(min, max)
    : isObject$1
...
function setEntries() {
  var _a, _b;
  const result = filterDeep(state.test && state$1.active === 'post'
    ? [
      Object.assign(Object.assign({}, state.entriesPost[0]), { children: ((_b = (_a = state.entriesPost) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.children) &&
          getEntriesSliced(state.entriesPost[0].children) }),
    ]
    : state[`entries${capitalizeFirstLetter(state$1.active)}`], (o) => {
    return ((o.name &&
...
export { state$1 as a, setEntries as b, setSearchPlaceholder as c, filterDeep as d, capitalizeFirstLetter as e, focusSearch as f, findDeep as g, get as h, compact as i, set as j, someDeep as k, camelCase as l, merge as m, isBoolean as n, isNumber as o, debounce as p, onChange$1 as q, resetView as r, state as s, onChange as t, unset as u };
