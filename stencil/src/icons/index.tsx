...
export function IconCustom() {
  return (
    <svg style={{ height: '14px' }} xmlns="http://www.w3.org/2000/svg">
      <path
        fill="currentColor"
...
export function IconFilterSlash() {
  return (
    <svg
      style={{ height: '14px' }}
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
      <path
        fill="currentColor"
        d="M630.8 469.1l-231.1-181.2l168.1-203.7C585.1 63.28 570.8 32 543.3 32H96.7C90.11 32 84.28 33.88 79.38 36.9l-40.57-31.79c-4.406-3.438-9.625-5.109-14.78-5.109c-7.125 0-14.19 3.156-18.91 9.188c-8.188 10.44-6.375 25.53 4.062 33.7l591.1 463.1c10.5 8.203 25.56 6.328 33.69-4.078C643.1 492.4 641.2 477.3 630.8 469.1zM256 400c0 7.828 3.812 15.17 10.25 19.66l80 55.98C362 486.7 384 475.5 384 455.1v-58.33L256 297.3V400z"
      />
    </svg>
  );
}
