import { i as isSymbol, g as baseToString, t as toInteger, W as WeakMap, h as identity, j as baseCreate, k as isObject, l as root, m as copyArray, n as isObjectLike, o as isArray, p as shortOut, q as arrayEach, u as setToString, v as isIndex, w as apply, x as createAssigner, y as isPrototype, z as isArrayLike, A as copyObject, B as keys, C as assignValue, D as keysIn, E as get, S as Symbol, F as isArguments, G as arrayPush, H as overRest, I as baseGetTag, J as isPlainObject, K as baseRest, L as toKey, M as baseAssignValue, N as baseSlice, O as toString, P as arrayReduce, Q as toNumber, R as isIterateeCall, T as baseClone, U as baseIteratee, V as arrayMap, X as baseEach, Y as baseAssign, Z as eq, _ as baseMerge, $ as baseUnary, a0 as cacheHas, a1 as SetCache, a2 as isArrayLikeObject, a3 as last, a4 as getTag, a5 as mapToArray, a6 as arrayFilter, a7 as baseForOwn, a8 as baseForOwnRight, a9 as baseFor, aa as castFunction, ab as baseForRight, ac as isFunction, ad as toFinite, ae as isString, af as constant, ag as castPath, ah as parent, ai as nodeUtil, aj as baseIsEqual, ak as baseIsMatch, al as getMatchData, am as coreJsData, an as stubFalse, ao as baseIsNative, ap as baseMatches, aq as baseMatchesProperty, ar as setToArray, as as getAllKeysIn, at as baseUnset, au as baseGet, av as baseSet, aw as arraySome, ax as baseProperty, ay as hasIn, az as baseReduce, aA as baseEachRight, aB as baseKeys, aC as baseTimes, aD as isBuffer, aE as isTypedArray, aF as getPrototype, aG as baseTrim, aH as trimmedEndIndex, aI as Set$1, aJ as takeRight, aK as forEach, aL as forEachRight, aM as reduce, aN as memoize, aO as clone, aP as cloneDeep, aQ as isEmpty, aR as isEqual, aS as isLength, aT as isMap, aU as isSet, aV as toPlainObject, aW as has, aX as merge, d as set, aY as unset, aZ as iteratee, a_ as property, a$ as stubArray, b0 as toPath, b1 as filterDeep, c as capitalizeFirstLetter, f as findDeep, a as setEntries } from './setSearchPlaceholder-25f695c9.js';
import { s as state } from './internal-d7978ed0.js';
import { f as fetchAjax } from './fetchAjax-7c3eab78.js';
import { h } from './index-ac9abc62.js';
...
function setFavourite(obj) {
  ...
  if (!obj.favourite) {
    ...
    const topChildrenLength = topPath
      ? Object.values(get(state.entriesFav, `${topPath}.children`))
        .length
      : false;
...
export { Fav as F, Heart as H, setFavourite as s, tippy as t };
