...
<streamline-button type="primary">
      <mock:shadow-root>
        <div class="inline-flex relative w-full">
          <div class="focus">
            <button class="bg-[#191E23] bg-transparent border-b border-blue-gray-300 border-none break-words cursor-pointer fill-current flex flex-col h-[calc(var(--sl-side-w))] h-[var(--sl-side-w)] hover:bg-[#0e1114] items-center justify-center p-0 text-center text-blue-gray-900 text-white underline-none w-[calc(var(--sl-side-w)-1px)] w-[max-content] w-[var(--sl-side-w)] whitespace-no-wrap" tabindex="0"></button>
          </div>
        </div>
      </mock:shadow-root>
    </streamline-button>
...
<streamline-button icon="menu" type="sidebar">
      <mock:shadow-root>
        <div class="inline-flex relative w-full">
          <div class="focus focus--px-x focus--px-y">
            <button class="!content-center !grid !justify-items-center bg-transparent border-b border-blue-gray-300 break-words cursor-pointer false flex flex-col h-[calc(var(--sl-side-w))] hover:bg-blue-gray-100 hover:text-blue-gray-900 items-center justify-center p-0 sm:!grid-rows-[20px,20px] text-center text-blue-gray-500 text-blue-gray-900 underline-none w-[calc(var(--sl-side-w)-1px)] w-[max-content] whitespace-no-wrap" tabindex="0" style="border-bottom: 1px solid rgba(209,213,219,var(--tw-border-opacity));">
...
<streamline-button icon="menu" type="sidebar">
      <mock:shadow-root>
        <div class="inline-flex relative w-full">
          <div class="focus focus--px-x focus--px-y">
            <button class="!content-center !grid !justify-items-center -right-px bg-transparent bg-white border-b border-blue-gray-300 border-r border-white break-words cursor-pointer flex flex-col h-[calc(var(--sl-side-w))] hover:!bg-white hover:bg-blue-gray-100 hover:text-blue-gray-900 items-center justify-center p-0 pointer-events-none relative sm:!grid-rows-[20px,20px] text-center text-blue-gray-500 text-blue-gray-900 text-blue-700 underline-none w-[calc(var(--sl-side-w)-1px)] w-[max-content] whitespace-no-wrap" tabindex="-1" style="border-bottom: 1px solid rgba(209,213,219,var(--tw-border-opacity));">
              <svg class="fill-current h-[18px]" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                <path d="M328 256c0 39.8-32.2 72-72 72s-72-32.2-72-72 32.2-72 72-72 72 32.2 72 72zm104-72c-39.8 0-72 32.2-72 72s32.2 72 72 72 72-32.2 72-72-32.2-72-72-72zm-352 0c-39.8 0-72 32.2-72 72s32.2 72 72 72 72-32.2 72-72-32.2-72-72-72z" fill="currentColor"></path>
              </svg>
            </button>
      ...
      <mock:shadow-root>
        <div class="inline-flex relative w-full">
          <div class="focus focus--border">
            <button class="bg-blue-gray-50 border border-blue-gray-200 break-words cursor-pointer hover:border-blue-600 leading-none min-w-[75px] px-3 py-2.5 text-center text-blue-600 text-sm underline-none w-[max-content] whitespace-no-wrap" tabindex="0" style="border-bottom: 1px solid rgba(209,213,219,var(--tw-border-opacity));"></button>
          </div>
...
<streamline-button favourite="" type="main">
      <mock:shadow-root>
        <div class="inline-flex relative w-full">
          <div class="focus focus--border">
            <button class="bg-blue-gray-50 border border-blue-gray-200 break-words cursor-pointer hover:border-blue-600 leading-none min-w-[75px] px-3 py-2.5 text-center text-blue-600 text-sm underline-none w-[max-content] whitespace-no-wrap" tabindex="0" style="border-bottom: 1px solid rgba(209,213,219,var(--tw-border-opacity));"></button>
            <span class="-right-1 -top-1 absolute bg-white border border-blue-gray-200 flex h-4 items-center justify-center pointer-events-none rounded-full text-red-500 w-4">
